...
Скачать PGP4Win можно с официального сайта, либо с нашего сервера. Программа распространяется бесплатно, однако на официальном сайте разработчики настойчиво просят пожертвовать, но при отсутствии возможности помочь скачать все равно можно.
![PGP-шифрование Windows](/images/posts/pgp-windows/0.png)
Для этого со страницы PayPal нужно вернуться на страницу загрузки. 
![PGP-шифрование Windows](/images/posts/pgp-windows/1.png)
![PGP-шифрование Windows](/images/posts/pgp-windows/2.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/3.png)
Если вы не знаете, что такое контрольная сумма и как ее проверять - ознакомьтесь с соответствующей статьей.
![PGP-шифрование Windows](/images/posts/pgp-windows/4.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/5.png)
Список ключей пуст, Kleopatra предлагает импортировать существующие ключи, либо создать новый.
![PGP-шифрование Windows](/images/posts/pgp-windows/6.png)
Мы создадим новый, нажав на "Создать новую пару ключей". Заполняя поля "Имя" и "Адрес электронной почты" важно понимать, что указанные данные будут видны всем обладателям нашего публичного ключа, т.е. всем нашим собеседникам, а реальной привязки к почте не осуществляется.
![PGP-шифрование Windows](/images/posts/pgp-windows/7.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/8.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/9.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/10.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/11.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/12.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/13.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/17.png)
![PGP-шифрование Windows](/images/posts/pgp-windows/18.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/19.png)
![PGP-шифрование Windows](/images/posts/pgp-windows/20.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/21.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/22.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/23.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/24.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/25.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/26.png)
...
![PGP-шифрование Windows](/images/posts/pgp-windows/27.png)
