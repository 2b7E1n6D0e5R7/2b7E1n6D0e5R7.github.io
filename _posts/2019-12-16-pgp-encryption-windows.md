...
В этой статье мы [spoler]разберем[/spoiler] практическую часть использования PGP-шифрования на Windows на примере кроссплатформенной Kleopatra.  Бесплатный менеджер ключей Kleopatra - это графическая оболочка GnuPG, а GPG4Win - удобное решение для Windows, в состав которого входит и упомянутый продукт. Если вы не имеете общего представления о PGP-шифровании, можете ознакомиться с вводной [статьей<i class="fa fa-external-link"></i>]({{site.baseurl}}/what-is-gpg-pgp-encryption){:target="_blank"} по этой теме.
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/0.png)]({{site.baseurl}}/images/posts/pgp-windows/0.png "увеличить изображение"){:target="_blank"}{:class="zoom-in"}

Для этого со страницы PayPal нужно вернуться на страницу загрузки. 

[![PGP-шифрование Windows](/images/posts/pgp-windows/1.png)]({{site.baseurl}}/images/posts/pgp-windows/1.png){:target="_blank"}{:class="zoom-in"}

[![PGP-шифрование Windows](/images/posts/pgp-windows/2.png)]({{site.baseurl}}/images/posts/pgp-windows/2.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/3.png)]({{site.baseurl}}/images/posts/pgp-windows/3.png){:target="_blank"}{:class="zoom-in"}

Если вы не знаете, что такое контрольная сумма и как ее проверять - ознакомьтесь с соответствующей статьей.

[![PGP-шифрование Windows](/images/posts/pgp-windows/4.png)]({{site.baseurl}}/images/posts/pgp-windows/4.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/5.png)]({{site.baseurl}}/images/posts/pgp-windows/5.png){:target="_blank"}{:class="zoom-in"}

Список ключей пуст, Kleopatra предлагает импортировать существующие ключи, либо создать новый.

[![PGP-шифрование Windows](/images/posts/pgp-windows/6.png)]({{site.baseurl}}/images/posts/pgp-windows/6.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/7.png)]({{site.baseurl}}/images/posts/pgp-windows/7.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/8.png)]({{site.baseurl}}/images/posts/pgp-windows/8.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/9.png)]({{site.baseurl}}/images/posts/pgp-windows/9.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/10.png)]({{site.baseurl}}/images/posts/pgp-windows/10.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/11.png)]({{site.baseurl}}/images/posts/pgp-windows/11.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/12.png)]({{site.baseurl}}/images/posts/pgp-windows/12.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/13.png)]({{site.baseurl}}/images/posts/pgp-windows/13.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/14.png)]({{site.baseurl}}/images/posts/pgp-windows/14.png){:target="_blank"}{:class="zoom-in"}

## 2. Блокнот.
Удобным инструментом для непосредственной работы с текстом является встроенный блокнот.

[![PGP-шифрование Windows](/images/posts/pgp-windows/15.png)]({{site.baseurl}}/images/posts/pgp-windows/15.png){:target="_blank"}{:class="zoom-in"}

Во вкладке "Получатели" аналогично настраиваются подпись и шифрование, в том числе для нескольких адресатов.

[![PGP-шифрование Windows](/images/posts/pgp-windows/16.png)]({{site.baseurl}}/images/posts/pgp-windows/16.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/17.png)]({{site.baseurl}}/images/posts/pgp-windows/17.png){:target="_blank"}{:class="zoom-in"}
[![PGP-шифрование Windows](/images/posts/pgp-windows/18.png)]({{site.baseurl}}/images/posts/pgp-windows/18.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/19.png)]({{site.baseurl}}/images/posts/pgp-windows/19.png){:target="_blank"}{:class="zoom-in"}
[![PGP-шифрование Windows](/images/posts/pgp-windows/20.png)]({{site.baseurl}}/images/posts/pgp-windows/20.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/21.png)]({{site.baseurl}}/images/posts/pgp-windows/21.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/22.png)]({{site.baseurl}}/images/posts/pgp-windows/22.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/23.png)]({{site.baseurl}}/images/posts/pgp-windows/23.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/24.png)]({{site.baseurl}}/images/posts/pgp-windows/24.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/25.png)]({{site.baseurl}}/images/posts/pgp-windows/25.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/26.png)]({{site.baseurl}}/images/posts/pgp-windows/26.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/27.png)]({{site.baseurl}}/images/posts/pgp-windows/27.png){:target="_blank"}{:class="zoom-in"}
...
[![PGP-шифрование Windows](/images/posts/pgp-windows/28.png)]({{site.baseurl}}/images/posts/pgp-windows/28.png){:target="_blank"}{:class="zoom-in"}

Для удобства название файла можно отредактировать.

[![PGP-шифрование Windows](/images/posts/pgp-windows/29.png)]({{site.baseurl}}/images/posts/pgp-windows/29.png){:target="_blank"}{:class="zoom-in"}

Для передачи открытого ключа можно использовать созданный файл, либо скопировать содержимое и отправить его в письме.

[![PGP-шифрование Windows](/images/posts/pgp-windows/30.png)]({{site.baseurl}}/images/posts/pgp-windows/30.png){:target="_blank"}{:class="zoom-in"}

<b>P.S.</b> PGP инструменты, как и сам протокол, имеют стандартизированный функционал, благодаря чему освоение этой программы позволит быстро сориентироваться в любой другой аналогичной. Будем внимательны при хранении закрытого ключа, потому что, если он попадет в чужие руки, его можно считать скомпрометированным. Злоумышленнику останется только подобрать (или своровать) фразу-пароль для полного завладения нашим крипто-именем. Для импорта ключа, если он предоставлен нам только где-то в чате, достаточно создать текстовый файл и вставить в него текст ключа, после чего импортировать стандартным способом.
